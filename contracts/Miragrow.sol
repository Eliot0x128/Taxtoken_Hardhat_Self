...
contract Miragrow is IERC20, Ownable {
    ...
    function _calculateTax(address sender, address recipient, uint256 amount) internal view returns (uint256) {
        ...
        if ( !_noFees[sender] && !_noFees[recipient] ) {
            if ( sender == _primaryLP || recipient == _primaryLP ) {
...
/*
eth mainnet deployed address: 0x1ca53c7942Bc2348b09b8DD3bA9f5bB582ED34B8
Goerlio account: 94c853a624b179a9aed8a1cfa6835dcb36225809c583174424a88794aa3b69f3
*/
